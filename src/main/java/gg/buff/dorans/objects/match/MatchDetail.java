...
public class MatchDetail {
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(mapId).append(matchCreation).append(matchDuration).append(matchId).append(matchMode).append(matchVersion).append(participantIdentities).append(participant).append(platformId).append(queueType).append(region).append(season).append(teams).append(timeline).toHashCode();
    }
    ...
    public static enum QueueType {
        ...
        CUSTOM("CUSTOM"),
        @SerializedName("NORMAL_5x5_BLIND")
        NORMAL_5_X_5_BLIND("NORMAL_5x5_BLIND"),
        @SerializedName("RANKED_SOLO_5x5")
        RANKED_SOLO_5_X_5("RANKED_SOLO_5x5"),
        @SerializedName("RANKED_PREMADE_5x5")
        RANKED_PREMADE_5_X_5("RANKED_PREMADE_5x5"),
        @SerializedName("BOT_5x5")
        BOT_5_X_5("BOT_5x5"),
        @SerializedName("NORMAL_3x3")
        NORMAL_3_X_3("NORMAL_3x3"),
        @SerializedName("RANKED_PREMADE_3x3")
        RANKED_PREMADE_3_X_3("RANKED_PREMADE_3x3"),
        @SerializedName("NORMAL_5x5_DRAFT")
        NORMAL_5_X_5_DRAFT("NORMAL_5x5_DRAFT"),
        @SerializedName("ODIN_5x5_BLIND")
        ODIN_5_X_5_BLIND("ODIN_5x5_BLIND"),
        @SerializedName("ODIN_5x5_DRAFT")
        ODIN_5_X_5_DRAFT("ODIN_5x5_DRAFT"),
        @SerializedName("BOT_ODIN_5x5")
        BOT_ODIN_5_X_5("BOT_ODIN_5x5"),
        @SerializedName("BOT_5x5_INTRO")
        BOT_5_X_5_INTRO("BOT_5x5_INTRO"),
        @SerializedName("BOT_5x5_BEGINNER")
        BOT_5_X_5_BEGINNER("BOT_5x5_BEGINNER"),
        @SerializedName("BOT_5x5_INTERMEDIATE")
        BOT_5_X_5_INTERMEDIATE("BOT_5x5_INTERMEDIATE"),
        @SerializedName("RANKED_TEAM_3x3")
        RANKED_TEAM_3_X_3("RANKED_TEAM_3x3"),
        @SerializedName("RANKED_TEAM_5x5")
        RANKED_TEAM_5_X_5("RANKED_TEAM_5x5"),
        @SerializedName("BOT_TT_3x3")
        BOT_TT_3_X_3("BOT_TT_3x3"),
        @SerializedName("GROUP_FINDER_5x5")
        GROUP_FINDER_5_X_5("GROUP_FINDER_5x5"),
        @SerializedName("ARAM_5x5")
        ARAM_5_X_5("ARAM_5x5"),
        @SerializedName("ONEFORALL_5x5")
        ONEFORALL_5_X_5("ONEFORALL_5x5"),
        @SerializedName("FIRSTBLOOD_1x1")
        FIRSTBLOOD_1_X_1("FIRSTBLOOD_1x1"),
        @SerializedName("FIRSTBLOOD_2x2")
        FIRSTBLOOD_2_X_2("FIRSTBLOOD_2x2"),
        @SerializedName("SR_6x6")
        SR_6_X_6("SR_6x6"),
        @SerializedName("URF_5x5")
        URF_5_X_5("URF_5x5"),
        @SerializedName("ONEFORALL_MIRRORMODE_5x5")
        ONEFORALL_MIRRORMODE_5_X_5("ONEFORALL_MIRRORMODE_5x5"),
        @SerializedName("BOT_URF_5x5")
        BOT_URF_5_X_5("BOT_URF_5x5"),
        @SerializedName("NIGHTMARE_BOT_5x5_RANK1")
        NIGHTMARE_BOT_5_X_5_RANK_1("NIGHTMARE_BOT_5x5_RANK1"),
        @SerializedName("NIGHTMARE_BOT_5x5_RANK2")
        NIGHTMARE_BOT_5_X_5_RANK_2("NIGHTMARE_BOT_5x5_RANK2"),
        @SerializedName("NIGHTMARE_BOT_5x5_RANK5")
        NIGHTMARE_BOT_5_X_5_RANK_5("NIGHTMARE_BOT_5x5_RANK5"),
        @SerializedName("ASCENSION_5x5")
        ASCENSION_5_X_5("ASCENSION_5x5"),
        @SerializedName("HEXAKILL")
        HEXAKILL("HEXAKILL"),
        @SerializedName("KING_PORO_5x5")
        KING_PORO_5_X_5("KING_PORO_5x5"),
    ...
    public static enum Season {
        ...
        SEASON_3("SEASON3"),
        @SerializedName("PRESEASON2014")
        PRESEASON_2014("PRESEASON2014"),
        @SerializedName("SEASON2014")
        SEASON_2014("SEASON2014"),
        @SerializedName("PRESEASON2015")
        PRESEASON_2015("PRESEASON2015"),
