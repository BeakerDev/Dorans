...
public class Event {
    ...
    /**
     * The skill slot of the event. Only present if relevant. Killer ID 0 indicates a minion.
     * <p>
     * 
     * 
     */
    ...
    /**
     * The team ID of the event. Only present if relevant. Killer ID 0 indicates a minion.
     * <p>
     * 
     * 
     */
    ...
    public static enum AscendedType {
        ...
        CHAMPION_ASCENDED("CHAMPION_ASCENDED"),
        @SerializedName("CLEAR_ASCENDED")
        CLEAR_ASCENDED("CLEAR_ASCENDED"),
        @SerializedName("MINION_ASCENDED")
    ...
    public static enum LaneType {
        ...
        BOT_LANE("BOT_LANE"),
        @SerializedName("MID_LANE")
        MID_LANE("MID_LANE"),
        @SerializedName("TOP_LANE")
        TOP_LANE("TOP_LANE");
        private final String value;
    ...
    public static enum MonsterType {
        ...
        @SerializedName("BLUE_GOLEM")
        BLUE_GOLEM("BLUE_GOLEM"),
        @SerializedName("DRAGON")
        DRAGON("DRAGON"),
        @SerializedName("RED_LIZARD")
        RED_LIZARD("RED_LIZARD"),
        @SerializedName("VILEMAW")
        VILEMAW("VILEMAW");
        private final String value;
    ...
    public static enum PointCaptured {
        ...
        POINT_B("POINT_B"),
        @SerializedName("POINT_C")
        POINT_C("POINT_C"),
        @SerializedName("POINT_D")
        POINT_D("POINT_D"),
        @SerializedName("POINT_E")
        POINT_E("POINT_E");
        private final String value;
    ...
    public static enum TowerType {
        ...
        @SerializedName("FOUNTAIN_TURRET")
        FOUNTAIN_TURRET("FOUNTAIN_TURRET"),
        @SerializedName("INNER_TURRET")
        INNER_TURRET("INNER_TURRET"),
        @SerializedName("NEXUS_TURRET")
        NEXUS_TURRET("NEXUS_TURRET"),
        @SerializedName("OUTER_TURRET")
        OUTER_TURRET("OUTER_TURRET"),
        @SerializedName("UNDEFINED_TURRET")
    ...
    public static enum WardType {
        ...
        @SerializedName("TEEMO_MUSHROOM")
        TEEMO_MUSHROOM("TEEMO_MUSHROOM"),
        @SerializedName("UNDEFINED")
        UNDEFINED("UNDEFINED"),
        @SerializedName("VISION_WARD")
        VISION_WARD("VISION_WARD"),
        @SerializedName("YELLOW_TRINKET")
        YELLOW_TRINKET("YELLOW_TRINKET"),
        @SerializedName("YELLOW_TRINKET_UPGRADE")
