...
public class CurrentGame {
	...
	public static enum GameMode {
		...
		CLASSIC("CLASSIC"), @SerializedName("ODIN")
		ODIN("ODIN"), @SerializedName("ARAM")
		ARAM("ARAM"), @SerializedName("TUTORIAL")
		TUTORIAL("TUTORIAL"), @SerializedName("ONEFORALL")
		ONEFORALL("ONEFORALL"), @SerializedName("ASCENSION")
		ASCENSION("ASCENSION"), @SerializedName("FIRSTBLOOD")
		FIRSTBLOOD("FIRSTBLOOD"), @SerializedName("KINGPORO")
		KINGPORO("KINGPORO");
