...
public class Rune {
	...
	@Override
	public int hashCode() {
		return new HashCodeBuilder().append(colloq).append(consumeOnFull).append(consumed).append(depth).append(description).append(from).append(group).append(hideFromAll).append(id).append(image).append(inStore).append(into).append(maps).append(name).append(plaintext).append(requiredChampion).append(rune).append(sanitizedDescription).append(specialRecipe).append(stacks).append(stats).append(tags).toHashCode();
	}
